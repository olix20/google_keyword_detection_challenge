    ...
    for i in tqdm(range(50)):
        ...
        callbacks = [EarlyStopping(monitor='val_loss',
                     ...
                     ModelCheckpoint(monitor='val_loss',
                                     filepath='weights/nn_massive_2dconv_vanilla/{}.hdf5'.format(exp_name),
                                     save_best_only=True,
        ...
        model.load_weights('./weights/nn_massive_2dconv_vanilla/{}.hdf5'.format(exp_name))
        ...
        np.save("cache/nn_massive_2dconv_vanilla/predictions_{}-{}.npy".format(exp_name,bst_val_score),predictions)