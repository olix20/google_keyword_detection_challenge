...
if __name__=="__main__":
    ...
    for i in tqdm(range(50)):
        ...
        unknown_pct = np.random.randint(6,11)
        ...
        callbacks = [EarlyStopping(monitor='val_loss',
                     ...
                     ModelCheckpoint(monitor='val_loss',
                                     filepath='weights/nn_massive_freq1d/{}.hdf5'.format(exp_name),
                                     save_best_only=True,
        ...
        model.load_weights('./weights/nn_massive_freq1d/{}.hdf5'.format(exp_name))
